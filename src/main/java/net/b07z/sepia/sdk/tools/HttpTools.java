...
public class HttpTools {
	...
	/**
	 * Post file and parameters to URL.
	 * @param url - POST url
	 ...
	 */
	public static boolean httpFilePOST(String url, String fileKey, File file, HashMap<String, String> stringPVs) throws IOException, ParseException{
