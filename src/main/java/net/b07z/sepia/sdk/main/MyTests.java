...
import net.b07z.sepia.sdk.services.uid1007.MqttDemo;
...
public class MyTests {
	...
	public static void main(String[] args) {
        ...
        ServiceInterface service = new MqttDemo(); //new PythonBridgeDemo(); //new RestaurantDemo(); new WorkoutHelperDemo();
